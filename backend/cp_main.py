...
app.mount(
    "/uploads/radiologist",
    StaticFiles(directory="radiologist/uploads"),
...
os.makedirs(os.path.join(BASE_DIR, "radiologist/nii_thumbnails"), exist_ok=True)
...
app.mount("/uploads/thumbnails", StaticFiles(directory=os.path.join(BASE_DIR, "radiologist/nii_thumbnails")), name="nii_thumbnails")
