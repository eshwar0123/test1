      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize:'26px', fontWeight:700, color:'#fff', marginBottom:6 }}>Clinical Portal</div>
            ...
            <p style={{ fontSize:'14px', color:'rgba(159,225,203,0.85)', lineHeight:1.7, fontWeight:300, margin:0 }}>
              AI-powered radiology platform for precision diagnostics and seamless report management.
            </p>
          </div>
          <div>
