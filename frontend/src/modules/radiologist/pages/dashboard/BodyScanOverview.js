  ...
  return (
    <div
      style={{
        position: "relative",
        width: "100%",
        maxWidth: isFullscreen ? "100%" : 430,
        height: isFullscreen ? "100%" : 560,
        minHeight: isFullscreen ? "calc(100vh - 260px)" : 560,
        margin: "0 auto",
        overflow: "hidden",
      }}
    >
  ...
  return (
    <CCard
      ...
      style={{
        ...
        background: isDark ? "#1f2d45" : "#fff",
        border: isDark ? "1px solid rgba(159,196,255,0.14)" : undefined,
      }}
    >
      <CCardHeader
        className="border-0"
        style={{
          ...
          paddingBottom: 8,
          background: isDark ? "#1f2d45" : "#fff",
          borderBottom: isDark ? "1px solid rgba(159,196,255,0.14)" : undefined,
        }}
      >
        <div
        ...
        >
          <div>
            <h5 className="mb-1" style={{ color: isDark ? "#ffffff" : "#111827", fontWeight: 700 }}>Body Scan Overview</h5>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
            <div style={{ minWidth: 170 }}>
              <CFormSelect value={filter} onChange={(e) => setFilter(e.target.value)}
                style={{ background: isDark ? "#29496f" : undefined, color: isDark ? "#f4f8ff" : undefined, borderColor: isDark ? "rgba(159,196,255,0.2)" : undefined }}>
      ...
      <CCardBody>
        ...
        >
          ...
          <div>
            <div
              style={{
                ...
                minHeight: isFullscreen ? "calc(100vh - 210px)" : 620,
                height: "100%",
          ...
          <div>
            <div
              style={{
                border: isDark ? "1px solid rgba(159,196,255,0.14)" : "1px solid #e5e7eb",
                borderRadius: 14,
                padding: isFullscreen ? 18 : 16,
                minHeight: isFullscreen ? "calc(100vh - 210px)" : 520,
                height: "100%",
                background: isDark ? "#29496f" : "#ffffff",
                display: "flex",
                flexDirection: "column",
              }}
            >
              <div className="d-flex align-items-center justify-content-between mb-3">
                <div>
                  <div style={{ fontSize: 12, color: isDark ? "#94a3b8" : "#6b7280" }}>Selected Region</div>
                  <div style={{ fontSize: 20, fontWeight: 700, color: isDark ? "#ffffff" : "#111827" }}>{selected.label}</div>
                </div>
              ...
              <div className="mb-3">
                <div style={{ fontSize: 12, marginBottom: 8, color: isDark ? "#94a3b8" : "#6b7280" }}>Modality Summary</div>
                <CRow className="g-2">
                  {modalityPills.map((pill) => {
                    const isActive  = filter === pill.key;
                    const isOverall = filter === "overall";
                    return (
                      <CCol md={3} key={pill.key}>
                        <div
                          style={{
                            border: `1px solid ${
                              isOverall ? `${pill.color}66` : isActive ? pill.color : isDark ? "rgba(159,196,255,0.2)" : "#e2e8f0"
                            }`,
                            borderRadius: 10,
                            padding: "12px 12px",
                        ...
                        >
                          <div style={{ fontSize: 12, fontWeight: 700, color: pill.color }}>
                            {pill.label}
                          </div>
                          <div style={{ fontSize: 18, fontWeight: 800, color: isDark ? "#ffffff" : "#111827", marginTop: 4 }}>{selected[pill.key]}</div>
                        </div>
                      </CCol>
                    );
                  })}
              ...
              <div style={{ marginTop: 4, flex: 1, overflowY: "auto", paddingRight: 4 }}>
                <div style={{ fontSize: 12, marginBottom: 8, color: isDark ? "#94a3b8" : "#6b7280" }}>Organ / Sub-part Breakdown</div>
                <div className="d-flex flex-column gap-2">
                  {organRows.map((organ) => (
                    <div
                      key={organ.key}
                      style={{
                        border: isDark ? "1px solid rgba(159,196,255,0.14)" : "1px solid #e2e8f0",
                        borderRadius: 10,
                        padding: "18px 12px",
                        background: isDark ? "#1e3a5f" : "#fff",
                      }}
                    >
                      <div
                        style={{
                  ...
                  {organRows.length === 0 && (
                    <div
                      style={{
                        border: isDark ? "1px dashed rgba(159,196,255,0.2)" : "1px dashed #cbd5e1",
                        borderRadius: 10,
                        padding: "14px 12px",
                        color: isDark ? "#94a3b8" : "#64748b",
                        background: isDark ? "#1e2d42" : "#f8fafc",
                        fontSize: 16,
                      }}
                    >
