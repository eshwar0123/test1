  ...
  return (
    <div className={cls} onClick={() => onSelect(item)}>
      ...
      <div className="r1-case-main">
        <div className="r1-case-id">{item.id}</div>
...
export default function Repository1() {
  ...
  const filtered = useMemo(() => {
    ...
    const statusFilters = ['pending', 'reading', 'completed', 'review'];
    if (statusFilters.includes(activeFilter))
      return cases.filter(c => c.status === activeFilter);
    if (['stat', 'urgent'].includes(activeFilter))
      return cases.filter(c => c.priority === activeFilter);
    if (['MRI', 'CT'].includes(activeFilter))
      return cases.filter(c => c.modality === activeFilter);
    return cases;
  }, [activeFilter, cases]);
  ...
  const filterChips = [
    ...
    { key: 'reading',   label: 'In Review' },
    { key: 'completed', label: 'Completed' },
  ];
  const modalityChips = ['MRI', 'CT'];
        ...
        <div className="r1-wl-header">
          ...
          <div className="r1-filter-bar">
            {filterChips.map(({ key, label }) => (
              <button
                key={key}
                className={`r1-chip${activeFilter === key ? ' r1-chip-active' : ''}`}
        ...
        {!selectedCase ? (
          ...
          <div className="r1-detail-content">
            ...
            <div className="r1-detail-header">
              <div className="r1-dh-id">{selectedCase.id}</div>
            ...
            <div className="r1-detail-section">
              ...
              {[
        ['Client ID',     selectedCase.clientId || '—'],
          ...
          <div className="r1-modal r1-report-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="r1-modal-body r1-report-body">
              ...
              <div className="r1-rpt-section">
                ...
                <div className="r1-rpt-row"><span className="r1-rpt-label">Case ID</span><span className="r1-rpt-value">{selectedCase.id}</span></div>
