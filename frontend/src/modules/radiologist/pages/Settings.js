  ...
  return (
    <CContainer fluid className="px-4 py-4">
      ...
      <CRow className="g-4">
        {/* ===================== PASSWORD SECTION ===================== */}
        <CCol xs={12}>
          <div style={{ borderRadius: 14, background: "rgba(219, 234, 254, 0.52)", backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)", border: "1px solid rgba(147,197,253,0.45)", boxShadow: "0 8px 32px rgba(30,80,160,0.10)", padding: "20px 24px" }}>
