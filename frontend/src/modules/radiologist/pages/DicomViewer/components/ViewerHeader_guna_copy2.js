  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Row 2: Case ID + Org ID + demographics (no patient name) ─── */}
        {(patientMeta || displayCaseId || displayClientId) && (
          <div
            style={{
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            {displayClientId && (
              <>
                {displayCaseId && <span style={{ color: "#334155", fontSize: 12 }}>·</span>}
                <span style={{ display: "inline-flex", alignItems: "center" }}>
            ...
            {patientMeta && (
              <>
                {(displayCaseId || displayClientId) && <span style={{ color: "#334155", fontSize: 12 }}>·</span>}
