      ...
      >
        ...
        <div style={toolItemStyle}>
          <button
            ...
            disabled={!isNifti} title="Crosshair" aria-label="Crosshair"
            style={{
              background: "#1f2937",
              color: isNifti ? "#e5e7eb" : "#6b7280",
        ...
        <div style={toolItemStyle}>
          <button
            className="vtb-btn"
            onClick={onInvert}
            disabled={!isNifti} title="Invert / Negative" aria-label="Invert"
            style={{
              background: "#1f2937",
              color: isNifti && isInverted ? "#fbbf24" : isNifti ? "#e5e7eb" : "#6b7280",
              border: isNifti && isInverted ? "2px solid #fbbf24" : "1px solid #1e2a3a",
              borderRadius: 6, padding: "8px 10px",
              display: "flex", alignItems: "center",
              cursor: isNifti ? "pointer" : "not-allowed",
            }}
        ...
        <div style={toolItemStyle}>
          <button
            className="vtb-btn"
            onClick={() => {
              if (isCornerstoneNifti) { scrollCornerstoneNifti(-1); return; }
            ...
            disabled={!isNifti} title="Rewind" aria-label="Rewind"
            style={{
              background: "#1f2937", border: "1px solid #1e2a3a",
              borderRadius: 6, padding: "8px 10px",
              display: "inline-flex", alignItems: "center", justifyContent: "center",
              color: isNifti ? "#e5e7eb" : "#6b7280",
              cursor: isNifti ? "pointer" : "not-allowed",
        ...
        <div style={toolItemStyle}>
          <button
            ...
            disabled={!isNifti} title={isPlaying ? "Pause" : "Play"} aria-label="Play/Pause"
            style={{
              background: "#1f2937",
              border: isNifti && isPlaying ? "2px solid #3b82f6" : "1px solid #1e2a3a",
              borderRadius: 6, padding: "8px 10px",
              display: "inline-flex", alignItems: "center", justifyContent: "center",
              color: isNifti ? "#e5e7eb" : "#6b7280",
              cursor: isNifti ? "pointer" : "not-allowed",
        ...
        <div style={toolItemStyle}>
          <button
            ...
            disabled={!isNifti} title="Forward" aria-label="Forward"
            style={{
              background: "#1f2937", border: "1px solid #1e2a3a",
              borderRadius: 6, padding: "8px 10px",
              display: "inline-flex", alignItems: "center", justifyContent: "center",
          ...
          <button
            ...
            onClick={() => {
              if (isCornerstoneNifti) {
                ...
                if (vp?.scroll) { vp.scroll(-100000); vp.render(); refreshNiftiSliceIndicators([activeNiftiSlot]); }
                return;
              }
              if (!isNifti || !niftiVol) return;
              setIsPlaying(false);
            ...
            disabled={!isNifti} title="Stop" aria-label="Stop"
            style={{
              background: "#1f2937", border: "1px solid #1e2a3a",
              borderRadius: 6, padding: "8px 10px",
              display: "inline-flex", alignItems: "center", justifyContent: "center",
